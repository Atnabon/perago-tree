    ...
    <>
      ...
      <div className="mt-5 mb-16 flex flex-col min-h-screen">
        <div className="lg:px-10">
          <TreeView setPositionChanged={setPositionChanged} className="py-5 md:py-10">{renderSubtrees(positions)}</TreeView>
        </div>
        <div className="mb-16">
          <Position addNewPosition={addNewPosition} positions={positionTree} setPositionChanged={setPositionChanged} />
        </div>
      </div>
